...
import com.capgemini.inventorymanagement.service.RawMaterialOrderService;
...
public class RawMaterialOrderController {
	...
	@Autowired
	RawMaterialOrderService serviceobj;
	...
	public ResponseEntity<String>addRawMaterialOrder(@RequestBody RawMaterialOrderDetails r )
	{
		...
		if(e == null)
		{
			...
			return new ResponseEntity<String>("RawMaterialOrder created successfully",new HttpHeaders(),HttpStatus.OK);		
		}
	}
